...
public class SkywarsPlugin extends PluginBase {
    ...
    public void onEnable () {
        ...
        GameID skyWarsGame = new GameID(Constants.GAME_ID,"sw", "Skywars", "Collect loot and be the last one standing!", "skywars", (String[])Constants.GAME_MAP_CATEGORY_TYPES.toArray(), 1, skyWarsProperties, SkywarsGameBehaviour.class);
        GameID skyWarsTourneyGame = new GameID("tourney_"+Constants.GAME_ID,"sw", "Skywars Tourney", "Collect loot and be the last one standing! Kills, wins, and top 3 placements give points!", "skywars", (String[])Constants.GAME_MAP_CATEGORY_TYPES.toArray(), 1, skyWarsTourneyProperties, SkywarsGameBehaviour.class);
