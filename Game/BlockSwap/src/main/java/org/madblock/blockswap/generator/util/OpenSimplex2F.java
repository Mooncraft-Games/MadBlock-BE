 ...
 *
 * <b>Taken from https://github.com/KdotJPG/OpenSimplex2 under the "Unlicense"</b>
 * 4D methods + fields + classes have been removed.
 */
public class OpenSimplex2F {
    ...
    private static long getNewSeed() {
        long i = incrementer.getAndAdd(new Random().nextInt(1234));
