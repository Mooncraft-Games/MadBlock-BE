...
public class PlayerRegistryReturns {
    ...
    public static final String LINK_FETCH_DETAILS_FROM_CODE_ERRORED = "fetch_link_details_error";
    public static final String LINK_CREATE_PAIRING_ERRORED = "create_link_pairing_error";
